...
-- Official copilot had some issues, check the README of the new copilot plugin being used
-- for more information

-- SETTINGS FOR UNOFFICIAL COPILOT
-- DEV: it is set at packer level because of dependency
